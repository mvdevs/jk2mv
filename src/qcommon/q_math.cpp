...
vec4_t	g_color_table[] =
	{
	{0.0, 0.0, 0.0, 1.0},    // ^0black
	{1.0, 0.0, 0.0, 1.0},    // ^1red
	{0.0, 1.0, 0.0, 1.0},    // ^2green
	{1.0, 1.0, 0.0, 1.0},    // ^3yellow
	{0.0, 0.0, 1.0, 1.0},    // ^4blue
	{0.0, 1.0, 1.0, 1.0},    // ^5cyan
	{1.0, 0.0, 1.0, 1.0},    // ^6magenta
	{1.0, 1.0, 1.0, 1.0},    // ^7white
	{ 1.0, 0.5, 0.0, 1.0 },  // ^8orange
	{ 0.5, 0.5, 0.5, 1.0 },	 // ^9grey
	};
