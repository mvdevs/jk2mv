...
qboolean QGL_Init( const char *dllname )
{
	...
	if ( ( glw_state.hinstOpenGL = LoadLibraryA( dllname ) ) == 0 )
	{
	...
	qwglCopyContext			  = (int (__stdcall *)(struct HGLRC__ *,struct HGLRC__ *,unsigned int))GPA( "wglCopyContext" );
	qwglCreateContext			= (struct HGLRC__ *(__stdcall *)(struct HDC__ *))GPA( "wglCreateContext" );
	qwglCreateLayerContext	   = (struct HGLRC__ *(__stdcall *)(struct HDC__ *,int))GPA( "wglCreateLayerContext" );
	qwglDeleteContext			= (int (__stdcall *)(struct HGLRC__ *))GPA( "wglDeleteContext" );
	qwglDescribeLayerPlane	   = (int (__stdcall *)(struct HDC__ *,int,int,unsigned int,struct tagLAYERPLANEDESCRIPTOR *))GPA( "wglDescribeLayerPlane" );
	...
	qwglShareLists			   = (int (__stdcall *)(struct HGLRC__ *,struct HGLRC__ *))GPA( "wglShareLists" );
	qwglSwapLayerBuffers		 = (int (__stdcall *)(struct HDC__ *,unsigned int))GPA( "wglSwapLayerBuffers" );
	qwglUseFontBitmaps		   = (int (__stdcall *)(struct HDC__ *,unsigned long,unsigned long,unsigned long))GPA( "wglUseFontBitmapsA" );
	qwglUseFontOutlines		  = (int (__stdcall *)(struct HDC__ *,unsigned long,unsigned long,unsigned long,float,float,int,struct _GLYPHMETRICSFLOAT *))GPA( "wglUseFontOutlinesA" );
